...
static void PrintfHardInfo(void)
{
    ...
    printf("  +5V       <------   5.0V      5V供电\r\n");
    printf("  GND       -------   GND       地\r\n");
	printf("  CS        <------   PC3       SPI_CS\r\n");
	printf("  RD/SCLK   <------   PA5       SPI_SCLK\r\n");
	printf("  DB7/DOUT  ------>   PA6       SPI_MISO\r\n");
	printf("  RAGE      <------   PB3       模拟信号输入量程\r\n");
	printf("  RST       <------   PB13      复位信号\r\n");
	printf("  CVA CVB   <------   PB12      启动AD转换\r\n");
	printf("  OS0       <------   GND       过采样引脚0(默认接地)\r\n");
	printf("  OS1       <------   GND       过采样引脚1(默认接地)\r\n");
	printf("  OS2       <------   GND       过采样引脚2(默认接地)\r\n");
	printf("  BUSY      ------>   PF6       BUSY信号\r\n");
	printf("打印采集数据: \r\n");
}
